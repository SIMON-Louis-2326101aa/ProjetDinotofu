...
- lancer un mode histoire séparé du bac à sable, avec prologue, chapitre 1 jouable et chapitre 2 déjà avancé jusqu'à la route courte sous garde.   

## Mode histoire   

Le mode histoire démarre volontairement limité : peu de boutiques, peu de routes, peu de stocks et des quêtes principales non refusables. Le joueur apprend d'abord qui sont Mira, Orren, Lysa, Bram, Soryn, Nell et Eda avant de comprendre pourquoi les routes se réécrivent.   
...
L'interface graphique est expérimentale. Elle sert déjà de base desktop HTML/JS, mais la version terminal reste la plus stable pour jouer à fond, vérifier les systèmes et publier une release propre.   
...
Les notes détaillées de versions sont séparées dans `PATCHNOTE_DINOTOFU.md`. Les README et fichiers de suivi ne servent pas de journal de patch : ils gardent seulement les informations utiles aux joueurs et au projet.   
