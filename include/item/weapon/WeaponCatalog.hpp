...
public:
    ...
    static Weapon createIronSword();
    static Weapon createReinforcedDagger();
    static Weapon createGuardSpear();
    static Weapon createHuntingBow();
    static Weapon createApprenticeStaff();
    static Weapon createHeavyIronAxe();
    static Weapon createWorkshopHammer();
    static Weapon createPatrolCrossbow();
    static Weapon createBalancedRapier();
    static Weapon createMercenarySabre();
    static Weapon createCurvedAmbushDagger();
    static Weapon createMilitiaLongbow();
    static Weapon createBoundOakStaff();
    static Weapon createRunicIronBlade();
    static Weapon createAmberEdgeDagger();
    static Weapon createAshenLongbow();
    static Weapon createChannelingScepter();
    static Weapon createRelayFalchion();
    static Weapon createWhistlingMineHammer();
    static Weapon createSingingResinStaff();
    static Weapon createColdLanternBow();
    static Weapon createRedClaySabre();
    static Weapon createBrokenMapDagger();
    static Weapon createFireflyIronRapier();
    static Weapon createDrownedLedgerMace();
    static Weapon createGreyCliffSpear();
    static Weapon createBrokenCarnivalWhip();
