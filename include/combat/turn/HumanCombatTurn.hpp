// EN: HumanCombatTurn.hpp briefly defines this Dinotofu module and its responsibilities.
// FR: HumanCombatTurn.hpp résume brièvement ce module de Dinotofu et ses responsabilités.
