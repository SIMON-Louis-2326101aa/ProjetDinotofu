...
// Description: Lists playable characters available on an account.
// TODO: Implement this future system when its feature block becomes active.

#ifndef INCLUDE_SAVE_REGISTRY_PLAYABLECHARACTERREGISTRY_HPP
#define INCLUDE_SAVE_REGISTRY_PLAYABLECHARACTERREGISTRY_HPP

class PlayableCharacterRegistry
{
public:
