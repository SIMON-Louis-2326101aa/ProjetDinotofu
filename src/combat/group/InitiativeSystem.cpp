// EN: InitiativeSystem.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: InitiativeSystem.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
