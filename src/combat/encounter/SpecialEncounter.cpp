// EN: SpecialEncounter.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: SpecialEncounter.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
...
#include "combat/encounter/SpecialEncounter.hpp"
