// EN: EncounterGenerator.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: EncounterGenerator.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
...
#include "combat/encounter/EncounterGenerator.hpp"
