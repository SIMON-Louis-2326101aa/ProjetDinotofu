// EN: InitiativeRoll.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: InitiativeRoll.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
