// EN: CombatRole.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: CombatRole.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
