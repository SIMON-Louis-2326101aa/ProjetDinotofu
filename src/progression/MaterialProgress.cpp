// EN: MaterialProgress.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: MaterialProgress.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
...
#include "progression/MaterialProgress.hpp"
