// EN: MaterialEntry.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: MaterialEntry.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
...
#include "progression/MaterialEntry.hpp"
