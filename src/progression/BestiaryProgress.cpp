// EN: BestiaryProgress.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: BestiaryProgress.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
...
#include "progression/BestiaryProgress.hpp"
