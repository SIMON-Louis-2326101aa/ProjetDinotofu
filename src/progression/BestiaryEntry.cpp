// EN: BestiaryEntry.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: BestiaryEntry.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
...
#include "progression/BestiaryEntry.hpp"
