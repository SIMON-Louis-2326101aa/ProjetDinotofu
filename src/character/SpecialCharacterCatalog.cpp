...
std::vector<SpecialCharacter> SpecialCharacterCatalog::getAllSpecialCharacters()
{
    return {
        SpecialCharacter(
            ...
            "Matt (PRO) n'est pas censé être jouable. Il sert de repère, de rival et de petite humiliation potentielle.",
            false,
            true,
            "",
            8
        ...
        SpecialCharacter(
            ...
            CharacterRace::Human,
            "Briseur lourd",
            "Tank à épée lourde deux mains, faible réussite future mais très lourds dégâts.",
        ...
        SpecialCharacter(
            ...
            CharacterRace::Human,
            "Guerrier",
            "Le dev : stats basiques, mais sous 50% PV il esquive mieux et critique presque toujours.",
        ...
        SpecialCharacter(
            ...
            CharacterRace::Human,
            "Chevalier",
            "Chevalier frontal, capable de revenir une fois à la vie plus tard.",
