// EN: RandomNameGenerator.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: RandomNameGenerator.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
