// EN: CombatRoleMenu.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: CombatRoleMenu.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
