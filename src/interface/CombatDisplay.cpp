// EN: CombatDisplay.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: CombatDisplay.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
