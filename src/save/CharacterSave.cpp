// EN: CharacterSave.cpp briefly defines this Dinotofu module and its responsibilities.
// FR: CharacterSave.cpp résume brièvement ce module de Dinotofu et ses responsabilités.
...
#include "save/CharacterSave.hpp"
